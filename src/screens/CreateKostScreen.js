        ...
        <View style={{marginLeft: 0}}>
          <Form>
            ...
            <Textarea
              rowSpan={3.5}
              placeholderTextColor="#bcbcbc"
              placeholder="Masukan Deskripsi Kost, misalnya: Kost sudah termasuk kasur, dekat dengan Bootcamp Arkademy, listrik ditanggung lucinta "
          ...
          <View style={styles.map}>
            {/* <Map
              sendData={this.handleMapMarker}
              getlocation={this.getFullAddress}
              Mode={'getdata'}
            /> */}
          </View>
          {/* LONG LAT */}
